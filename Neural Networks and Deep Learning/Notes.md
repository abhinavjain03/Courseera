...
* Number of nodes in layer l **n^[l]**. Eg. Input is layer 0. So *n^[0]=3,n^[1]=5,n^[2]=5,n^[3]=4*.
* Activations for layer l **a^[l]=g^\[l\](Z^\[l\])**
* Weights for layer l **W^[l]**
* Biases for layer l **b^[l]**
* *Z^[l]=np.dot(W^[l],a^[l-1]) + b^[l]*   
* Activation function for layer l *g^\[l\](x)*.
...
* Generally, **Z^[l] = (n^[l],m)**
* Shape of **A^[l] = Z^[l]**
* In vectorized implementation also, Shape of b^[l] = (n^[l],1) as it will use python broadcasting to be of the required dimensions.  
...
![DNN - Forward](imgs/DNN-forward.png)
  ...
  * Z[l] = W[l]A[l-1] + b[l]; keep caching Z[l] (for backprop)
  * A[l] = g[l](Z[l])
* **Backward**:
![DNN - Backward](imgs/DNN-backward.png)
  ...
  * *dZ[l] = np.dot(W[l+1].T,dZ[l+1])\*g'\[l\](Z[l])*
* Update:
